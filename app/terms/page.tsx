    ...
    <section className="py-16 md:py-20">
      <div className="container max-w-4xl">
        ...
        <div className="prose mt-10 space-y-8">
          <p>These sample terms outline permitted account usage, subscription billing expectations, household device limits, and support boundaries for Streamline IPTV.</p>
          ...
          <p>The service should be described consistently as a legal IPTV platform for licensed content only, with explicit restrictions against unauthorized redistribution.</p>
        </div>
      </div>
    </section>
  );
